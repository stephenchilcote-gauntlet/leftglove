...
**Note (Apr 7):** For current implementation status, architecture decisions,
and the active feature roadmap, see [notes/feature-vision.md](notes/feature-vision.md).
Some implementation details below (language choices, process model) have evolved.
